...
namespace API_MVC_Achados_e_Enchentes.Migrations
{
    ...
    [Migration("20240604175502_Criacao-Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_MVC_Achados_e_Enchentes.Models.Observacoes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API_MVC_Achados_e_Enchentes.Models.Pessoa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API_MVC_Achados_e_Enchentes.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API_MVC_Achados_e_Enchentes.Models.Observacoes", b =>
                {
                    b.HasOne("API_MVC_Achados_e_Enchentes.Models.Pessoa", "Pessoa")
                        .WithMany()
                        .HasForeignKey("PessoaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_MVC_Achados_e_Enchentes.Models.Usuario", "Usuario")
                        .WithMany()
